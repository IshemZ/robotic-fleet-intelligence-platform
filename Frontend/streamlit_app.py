...
vue_global = st.sidebar.segmented_control(
    options=["Décollage", "Atterissage"],
    label="Etat de l'avion",
    selection_mode="single",
)

choix = st.sidebar.selectbox("choisi un pays", ["France", "Allemagne"])

Projet1 = st.sidebar.button(
    "Vue 1", use_container_width=True, disabled=False, type="secondary"
)
